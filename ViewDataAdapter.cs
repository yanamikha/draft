...
namespace ClientServerServices
{
    public class ViewDataAdapter
    {
        ...
        public async Task FillDataGridViewAsync(string tokenValue, string viewName, DataGridView gridView = null, IList<VCondition> conditions = null)
        {
        ...
        {
            if (vGrid is null || index < 0 || vGrid.Columns.Count <= index) return null;
